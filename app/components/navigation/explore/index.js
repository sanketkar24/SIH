...
function explore() {
  return (
    <main className='flex flex-col justify-center items-center h-[100%] min-w-screen '>
      <div className="text-4xl pt-20 pb-5"><span className="font-semibold bg-amber-300 ">Personalized Self Assessment</span></div>
      <div className='font-light tablet:text-base text-sm '>AI Driven Conversations</div>
      ...
      <div className='flex tablet:flex-row flex-col flex-wrap overflow- mt-8 mb-8 items-center text-center justify-center'>
        ...
        <div className=" flex flex-col h-96 w-96 border mx-4 my-4 rounded-lg bg-[url('../images/photo1.jpeg')] text-white font-bold text-lg text-start px-4 justify-end pb-10">
          <div className="text-sm font-light text-white">
      
          </div>
        </div>
        <div className=" flex flex-col h-96 w-96 border mx-4 my-4 rounded-lg bg-[url('../images/photo2.jpeg')] text-white font-bold text-lg text-start px-4 justify-end pb-10">
          
          <div className="text-sm font-light text-white">
            
          </div>
        </div>
        <div className=" flex flex-col h-96 w-96 border mx-4 my-4 rounded-lg bg-[url('../images/photo3.jpeg')] text-white font-bold text-lg text-start px-4 justify-end pb-10">
        ...
        <div className=" flex flex-col h-96 w-96 border mx-4 my-4 rounded-lg bg-gray-700 text-white font-bold text-2xl px-4 pt-20 items-center">
          Looking to achieve <span className='pt-1'>Mental Peace ?</span>
